...
public class UserControllerTest {
    ...
    @Test
    public void savingUser_withPasswordHavingNonASCIICharacters_shouldFail() throws Exception {
        String userJson = "{\"username\":\"johndoe\",\"password\":\"programação\",\"email\":\"newuser@email.com\"}";
    ...
    @Test
    public void savingUser_withEmailHavingLessThan4CharactersInItsLocalPart_shouldFail() throws Exception {
        String userJson = "{\"username\":\"johndoe\",\"password\":\"user1234\",\"email\":\"eee@email.com\"}";
